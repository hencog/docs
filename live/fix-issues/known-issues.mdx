...
- **Mic Toggle Feature**\
  ...
  <Warning>
    Some games will still **automatically take the mic back**, but BeamXR Live will now show an on-screen indicator so you always know if your mic is live on stream. [******You must make sure Seamless Multitasking is enabled\!******](https://help.beamxr.io/live/getting-started/how-to-install#7-seamless-multitasking-see-chat-in-game)
  </Warning>
