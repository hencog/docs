...
<iframe class="w-full aspect-video rounded-xl" src="https://www.youtube-nocookie.com/embed/xMtoXGW1DkE?si=sfsi95-xgWCijoxp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
- Or log in with your **Meta Account**.
...
![6 Entire View JP](/images/6.EntireView.JPG)

Tap **Go Live** to start streaming instantly.

<Warning>
  You’ll be asked what to share — be sure to select **Entire View** to capture your full VR gameplay.
</Warning>

---

## 7.  Seamless Multitasking - See chat in-game

<iframe class="w-full aspect-video rounded-xl" src="https://www.youtube-nocookie.com/embed/r8-eYswlJmI?si=U3tg4P3oF71lXQxS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
